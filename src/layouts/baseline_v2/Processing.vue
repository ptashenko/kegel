<template>
    <div class="container-mob p-0">
      ...
      <p class="font-sans font-400 text-16px leading-normal text-center text-[#fff] mt-32px">{{ $t('processing.text') }}</p>
    </div>
</template>
