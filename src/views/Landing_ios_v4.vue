<template>
  <div class="relative max-w-full mx-auto pt-12px pb-64px sm:max-w-600px sm:pt-16px" >
    ...
    <div class="text-14px flex items-center justify-between my-16px mx-auto py-0 px-32px leading-normal sm:text-16px sm:leading-normal sm:px-38px">
      ...
      <div class="flex"><span class="opacity-50 mr-4px line-through">$6.6 </span><span class="font-600">&nbsp; $3.3*</span></div>
    ...
    <div id="paypal" class="px-32px mt-64px sm:px-40px sm:mt-48px">
      ...
      <base-button
          ...
          url="#paypal"
      />
      <p class="text-12px leading-normal opacity-50 text-center sm:text-14px sm:leading-normal" v-html="$t('landing.trialEnd14_33', {lastDate: $dayjs().add(14,'days').format('MMMM D YYYY, h:mm a')})">
      </p>
    </div>
  </div>
  <Footer />
