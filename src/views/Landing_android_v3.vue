<template>
  <div class="relative max-w-full mx-auto pt-12px pb-64px sm:(max-w-600px pt-16px)">
    ...
    <div id="paypal" class="px-32px mt-64px sm:(px-40px mt-48px)">
      ...
      <p class="text-12px leading-normal opacity-50 text-center sm:(text-14px leading-normal)" v-html="$t('landing.trialEnd14_33', {lastDate: $dayjs().add(14,'days').format('MMMM D YYYY, h:mm a')})">
      </p>
    </div>
  </div>
  <Footer />
