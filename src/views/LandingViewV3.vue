  ...
  <div class="landing">
          ...
          <div class="d-flex align-items-center justify-content-center flex-column">
            <div class="d-flex flex-column block__timer" >
              <div class="h2 main-title">
                Start enhancing your performance with the Dr. Kegel plan!
              </div>
              <div>
                <img src="@/assets/img/land_v3/img_rating.png" class="rating-img" alt="">
              </div>
              ...
              <div class="d-flex flex-column  mw-450" style="padding: 0">
                ...
                <button  class="btn__show__more" v-if="$store.state.review.fpl_land.length > numreview" @click="showReview">Show more</button>
              </div>

              <div class="small_info-block">
                <div class="small_info-block_wrapper">
                  <h4 class="small_info-block_title">This is how much it took to create the Dr. Kegel Plan</h4>
                  <div class="small_info-block_content">
                    <div class="small_info-block_content-block">
                      <div class="small_info-block_content-item">
                        <img src="@/assets/img/land_v3/6.svg" class="small_info-block_content-item_img" alt="">
                        <h4>700+</h4>
                        <p>Hours research</p>
                      </div>
                      <div class="small_info-block_content-item">
                ...
                <div class="small_info-block_wrapper">
                  ...
                  <div class="small_info-block_content">
                    ...
                    <div class="small_info-block_content-info">
                      ...
                      <div class="small_info-block_content-info-block">
                        <img src="@/assets/img/land_v3/down_arrow.svg" alt="">
                        <span>Male diseases</span>
                      </div>
                      <div class="small_info-block_content-info-block">
                        <img src="@/assets/img/land_v3/down_arrow.svg" alt="">
                        <span>Prostate cancer risk</span>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div id="paypal" class="step_2">
      ...
      <div class="mw-450 d-flex flex-column mb-32">
        <div class="item-li d-flex align-items-center mb-16">
    ...
    <div class="main-pre-footer">
      <div class="main-pre-footer_info">
        Disclaimer: All information provided is for educational use only. Always consult with your doctor or primary care physician prior to starting any new routine. This site is not a part of the Facebook website or Facebook Inc. Additionally, This site is NOT endorsed by Facebook in any way. FACEBOOK is a trademark of FACEBOOK, Inc.
      </div>
