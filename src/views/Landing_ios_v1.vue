<template>
  <div class="relative max-w-full mx-auto pt-12px pb-64px sm:max-w-600px sm:pt-16px">
    <div id="topPage" class="flex flex-col px-32px sm:px-40px">
      <div
        class="font-displayBold mt-0 mb-16px mx-auto text-32px font-600 leading-normal text-center sm:text-30px sm:leading-normal sm:mb-24px">
        {{ $t('landing.title') }}
      </div>
      <div id="trigger1" class="text-center mb-0">
        ...
        <div
          class="font-sansBold text-red font-700 text-20px leading-normal flex w-full mx-auto relative justify-center min-h-30px sm:text-24px sm:leading-normal sm:min-h-36px">
      ...
      <p class="text-14px opacity-50 text-center leading-normal font-light font-sansLight sm:text-16px sm:leading-normal">
        {{ $t('landing.diagram') }}</p>
    ...
    <div
      class="pt-16px px-32px pb-0 my-0 mx-auto leading-normal text-14px opacity-50 font-sans mt-0 sm:text-16px sm:leading-normal">
    ...
    <hr class="bg-[#F1F3F9] h-1px max-w-320px my-0 mx-auto px-0 py-0 border-none sm:max-w-520px">
    <div
      class="my-16px mx-auto py-0 px-32px pt-16px px-32px pb-0 my-0 mx-auto leading-normal text-14px opacity-50 font-sans sm:text-16px sm:px-38px sm:leading-normal">
