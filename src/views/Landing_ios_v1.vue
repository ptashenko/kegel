<template>
  <div class="relative max-w-full mx-auto pt-12px pb-64px sm:max-w-600px sm:pt-16px">
    <div id="topPage" class="flex flex-col px-32px sm:px-40px">
      <div
        class="font-display font-600 mt-0 mb-16px mx-auto text-32px font-600 leading-normal text-center sm:text-30px sm:leading-normal sm:mb-24px">
        {{ $t('landing.title') }}
      </div>
      <div id="trigger1" class="text-center mb-0">
        ...
        <div
          class="font-700 text-red font-700 text-20px leading-normal flex w-full mx-auto relative justify-center min-h-30px sm:text-24px sm:leading-normal sm:min-h-36px">
      ...
      <div class="my-24px mx-auto w-full">
        <lottie-animation class="animation" ref="content.ref" :animationData="imageitem" :loop="false" :autoPlay="true"
          :speed="1" />
        <div class="flex justify-between my-0 mx-33px sm:mx-54px">
          <p
            class="mt-9px mb-0 mx-0 text-12px text-[#111113] opacity-75 leading-normal sm:text-18px sm:mt-12px sm:mb-0 sm:mx-0 leading-normal">
            {{ $dayjs().add(0, 'month').format("MMM") }}</p>
          <p
            class="mt-9px mb-0 mx-0 text-12px text-[#111113] opacity-75 leading-normal sm:text-18px sm:mt-12px sm:mb-0 sm:mx-0 leading-normal">
            {{ $dayjs().add(1, 'month').format("MMM") }}</p>
          <p
            class="mt-9px mb-0 mx-0 text-12px text-[#111113] opacity-75 leading-normal sm:text-18px sm:mt-12px sm:mb-0 sm:mx-0 leading-normal">
            {{ $dayjs().add(2, 'month').format("MMM") }}</p>
          <p
            class="mt-9px mb-0 mx-0 text-12px text-[#111113] opacity-75 leading-normal sm:text-18px sm:mt-12px sm:mb-0 sm:mx-0 leading-normal">
            {{ $dayjs().add(3, 'month').format("MMM") }}</p>
          <p
            class="mt-9px mb-0 mx-0 text-12px text-[#111113] opacity-75 leading-normal sm:text-18px sm:mt-12px sm:mb-0 sm:mx-0 leading-normal">
            {{ $dayjs().add(4, 'month').format("MMM") }}</p>
          <p
            class="mt-9px mb-0 mx-0 text-12px text-[#111113] opacity-75 leading-normal sm:text-18px sm:mt-12px sm:mb-0 sm:mx-0 leading-normal">
            {{ $dayjs().add(5, 'month').format("MMM") }}</p>
        </div>
      </div>
      <p class="text-14px opacity-50 text-center leading-normal font-light font-300 sm:text-16px sm:leading-normal">
        {{ $t('landing.diagram') }}</p>
    ...
    <div class="bg-[#F1F3F9] py-16px px-32px mt-48px mx-auto mb-16px">
      <div class="font-display font-600 emiBold text-14px leading-normal sm:text-16px sm:leading-normal">
        {{ $t('landing.priceToday') }}
      </div>
    </div>
    <div
      class="text-14px flex items-center justify-between my-16px mx-auto py-0 px-32px leading-normal sm:text-16px sm:leading-normal sm:px-38px">
      <div>
        {{ $t('landing.dayTrial') }}
      </div>
      <div>
    ...
    <div
      class="pt-16px px-32px pb-0 my-0 mx-auto leading-normal text-14px opacity-50  mt-0 sm:text-16px sm:leading-normal">
    ...
    <div
      ...
      <div class="flex flex-col items-end">
        <div class="flex"><span class="opacity-50 mr-4px line-through">$6.6 </span><span class="font-600">&nbsp;
            $4.2*</span></div>
    ...
    <hr class="bg-[#F1F3F9] h-1px max-w-320px my-0 mx-auto px-0 py-0 border-none sm:max-w-520px">
    <div
      class="my-16px mx-auto py-0 px-32px pt-16px px-32px pb-0 my-0 mx-auto leading-normal text-14px opacity-50  sm:text-16px sm:px-38px sm:leading-normal">
    ...
    <div id="paypal" class="px-32px mt-64px sm:px-40px sm:mt-48px">
      <div class="mx-auto py-0 flex items-center justify-between text-16px leading-normal sm:mt-64px">
        ...
        <div class="flex flex-col items-end">
          <span class="cursor-pointer opacity-75 text-14px leading-normal font-display font-500"
            @click="toggleModal">{{ $t('landing.whyNow') }}</span>
        </div>
      </div>
      ...
      <div class="mt-48px mb-24px mx-auto py-0 leading-normal">
        <p class="font-display font-600 emiBold mb-12px">{{ $t('landing.email') }}</p>
      ...
      <div class="mb-24px mx-auto py-0 leading-normal">
        <p class="font-display font-600 emiBold mb-12px">{{ $t('landing.safeInfo') }}</p>
        <p class="text-14px leading-normal sm:text-16px sm:leading-normal">{{ $t('landing.info') }}</p>
      </div>
      <div class="mb-24px mx-auto py-0 leading-normal">
        <p class="font-display font-600 emiBold mb-12px">{{ $t('landing.secure') }}</p>
      ...
      <div class="my-0 mx-auto py-0 leading-normal">
        <p class="font-display font-600 emiBold mb-12px">{{ $t('landing.help') }}</p>
      ...
      <base-button
          ...
          url="#paypal"
      />
      <p class="text-12px leading-normal opacity-50 text-center sm:text-14px sm:leading-normal" v-html="$t('landing.trialEnd', {lastDate: $dayjs().add(7,'days').format('MMMM D YYYY, h:mm a')})">
      </p>
    </div>
  </div>
  <Footer />
  ...
  <vpopup class="flex justify-center items-top fixed z-9 top-32px left-0 right-0 bottom-0 bg-[#ffffff00]"
    v-if="windowError" error>
    <div class="flex items-center">
      <p class="opacity-75  font-500 text-red text-14px leading-normal">
        {{ $t('landing.error') }}
      </p>
      <img class="ml-16px" src="@/assets/images/svg/icon_btn-close-communicate.svg" alt="error" @click="closeWindowError">
    </div>
  </vpopup>
  {{ dataP3 }}
