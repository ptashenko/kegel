      ...
      <div class="container-mob">
        ...
        <div class="flex justify-evenly mt-48px">
          <div class="max-w-180px text-center">
            ...
            <p class="font-sans m-0 text-16px leading-normal sm:(text-18px leading-normal)">{{ $t('timePlan.hours') }}</p>
          </div>
          <div class="max-w-180px text-center">
            ...
            <p class="font-sans m-0 text-16px leading-normal sm:(text-18px leading-normal)">{{ $t('timePlan.analysis') }}</p>
          </div>
        </div>
        <footer-controls
          :buttonBack="{
