<template>
    <div class="bg-guarantee rounded-15px">
      <img
          src="@/assets/images/content/baseline_v2/img_moneyback.png"
      />
      <div class="p-31px">
        <h2
...
<style scoped>
.bg-guarantee {
  background: linear-gradient(180deg, rgba(241, 243, 249, 0.00) 0%, #F1F3F9 23.44%);;
}
</style>
