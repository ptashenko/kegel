    ...
    <div class="container-main is-page Final">
      <div class="mw-520">
        <div class="h2 text-center">
          Your Kegel Plan is waiting for you in the Dr. Kegel app
          <p>Download the app to start</p>
        </div>
      </div>
  ...
  mounted(){
      var oneLinkURL = "https://kegel.onelink.me/b5X4/";
            ...
            gtag('event', 'conversion', {
              ...
              'value': localStorage.getItem('price') == null ? 4.2 : localStorage.getItem('price'),
              'currency': 'USD',
              'transaction_id': ''
            });
  },
