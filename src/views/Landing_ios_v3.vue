<template>
  <div class="relative max-w-full mx-auto pt-12px pb-64px sm:max-w-600px sm:pt-16px">
    <div id="topPage" class="flex flex-col px-32px sm:px-40px">
      <div class="font-display font-600 old mt-0 mb-16px mx-auto text-32px font-600 leading-normal text-center sm:text-30px sm:leading-normal sm:mb-24px">
        {{ $t('landing.title') }}
      </div>
      <div id="trigger1" class="text-center mb-0">
        ...
        <div class="font-700 text-red font-700 text-20px leading-normal flex w-full mx-auto relative justify-center min-h-30px sm:text-24px sm:leading-normal sm:min-h-36px text-red font-700 text-20px leading-normal flex w-full mt-4px mb-0 mx-auto relative text-center justify-center">
      ...
      <p class="text-14px opacity-50 text-center leading-normal font-light font-300 sm:text-16px leading-normal">{{ $t('landing.diagram') }}</p>
      <div class="font-display font-600 old text-20px mt-16px mb-24px text-center leading-normal sm:text-24px sm:leading-normal sm:mt-32px sm:mb-52px">
        {{ $t('landing.benefits') }}
      </div>
    ...
    <div class="pt-16px px-32px pb-0 leading-normal text-14px opacity-50 mb-48px mx-auto mt-0 sm:text-16px sm:leading-normal">
